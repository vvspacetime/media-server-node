...
class OutgoingStreamTrack
{
	...
	*/
	 ...
	 * @param {waitingForIntra} waitingForIntra - Whether waiting for the intra frame before forwarding frame
	 * @returns {Transponder} Track transponder object
	 */
	attachTo(incomingStreamTrack, waitingForIntra = true)
	{
		...
		if (!this.transponder)
		{
			...
			const transponder  = new Native.RTPStreamTransponderFacade(this.source,this.sender,this,waitingForIntra);
